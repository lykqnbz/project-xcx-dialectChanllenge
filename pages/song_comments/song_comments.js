...
Page({
  ...
  onShareAppMessage: function (res) {
    ...
    if (res.from == 'button') {
      ...
      path = "/pages/song_comments/song_comments?jokeId=" + jokeId + "&from=童谣歌曲评论&position=button&inviterId=" + wx.getStorageSync("uid");
    } else {
      title = this.data.letterMap['jokeShare'].title;
      imgurl = this.data.letterMap['jokeShare'].imageUrl;
      path = "/pages/song_comments/song_comments?jokeId=" + jokeId + "&from=童谣歌曲评论&position=common&inviterId=" + wx.getStorageSync("uid");
    }
    return {
      title: title,
      path: path,
