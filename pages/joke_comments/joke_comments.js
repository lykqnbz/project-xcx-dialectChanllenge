  ...
  Page({
    ...
    onShareAppMessage: function (res) {
      ...
      if (res.from == 'button') {
        ...
        path = "/pages/joke_comments/joke_comments?jokeId=" + jokeId + "&from=方言笑话评论&position=button&inviterId=" + wx.getStorageSync("uid");
      } else {
        title = this.data.letterMap['jokeShare'].title;
        imgurl = this.data.letterMap['jokeShare'].imageUrl;
        path = "/pages/joke_comments/joke_comments?jokeId=" + jokeId + "&from=方言笑话评论&position=common&inviterId=" + wx.getStorageSync("uid");
      }
      return {
        title: title,
        path: path,
